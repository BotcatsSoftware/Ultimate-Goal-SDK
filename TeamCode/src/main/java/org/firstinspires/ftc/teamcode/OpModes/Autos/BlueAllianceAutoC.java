...
public class BlueAllianceAutoC extends LinearOpMode {
    DcMotor fl = null;
    DcMotor fr = null;
    DcMotor bl = null;
    DcMotor br = null;
    ...
    public void runOpMode() {
        ...
        driveForwardDistance(0.5, (int) 63.16);
        //push wobble goal into box
        driveLeftDistance(0.5, (int) 6.706);
        //drive back to line
        ...
        //shoot
        //park on line
        driveForwardDistance(0.5, (int) 13.412);
