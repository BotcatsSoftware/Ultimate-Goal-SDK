...
public class PushBotAutoB extends LinearOpMode {
    DcMotor fl = null;
    DcMotor fr = null;
    DcMotor bl = null;
    DcMotor br = null;
    ...
    public void runOpMode() {
        ...
        //correct
        driveForwardDistance(0.5, (int) (2226/TICKSTOMMTRAVELED));
        //push wobble goal into box
        //correct
        driveRightDistance(0.5, (int) (289/TICKSTOMMTRAVELED));
        //drive backwards to park on link
        driveBackDistance(0.5, (int) (578/TICKSTOMMTRAVELED));
